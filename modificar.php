...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sql = "SELECT * FROM dato WHERE id_dato = $id_dato";
    ...
    if ($result->num_rows == 1) {
        ...
        <input type="hidden" name="id_dato" value="<?php echo $row['id_dato']; ?>"><br><br>
        ...
        <input type="date" id="fechaNacimiento" name="fechaNacimiento" value="<?php echo $row['fechaNacimiento']; ?>"required><br><br>
